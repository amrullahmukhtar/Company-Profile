          ...
          <div className="item-center flex flex-col">
            ...
            <div className=" flex gap-5">
              ...
              <div className="max-w-[800px] min-w-[150px]">
                <img className="  rounded-xl" src="/about-1.jpg" />
              </div>
            </div>

            <div className="flex gap-10 justify-center flex-wrap my-10">
            ...
            <div className="flex flex-col">
              <span className="text-5xl text-center font-bold py-10">
                We are hapy to help solve your business problems.
              </span>
              <div className="gap-10 flex flex-row flex-wrap justify-center w-full">
                <img
                  className="max-w-[300px] min-w-[150px] rounded-xl"
                  src="https://images.pexels.com/photos/5686082/pexels-photo-5686082.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                  alt=""
                />
                <img
                  className="max-w-[300px] min-w-[150px] rounded-xl"
                ...
                <img
                  className="max-w-[300px] min-w-[150px] rounded-xl"
                  src="https://images.pexels.com/photos/5439474/pexels-photo-5439474.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                />
                <img
                  className="max-w-[300px] min-w-[150px] rounded-xl"
                  src="https://images.pexels.com/photos/5439408/pexels-photo-5439408.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                />
                <img
                  className="max-w-[300px] min-w-[150px] rounded-xl"
