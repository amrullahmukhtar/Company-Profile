        ...
        <div className="flex h-full justify-between p-5 ">
          <div className="flex h-full flex-col pr-2 gap-10 ">
            ...
            <div className="flex bg-emerald-500 rounded-full px-2 h-[50px] max-w-[250px] items-center justify-center animate-pulse z-1">
              {" "}
              <img className="h-4 pr-2" src="/wa.svg" />{" "}
            ...
            <div className="h-[30rem] w-[30rem] flex items-center justify-center ">
              <PinContainer>
                <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] ">
                  ...
                  <img src="https://asset.kompas.com/crops/DeBHHemYp-_IQL3VssioxUmIr1o=/0x0:900x600/750x500/data/photo/2022/12/10/63942b048a4b5.jpg" />
                </div>
              </PinContainer>
            </div>
            <div className="h-[30rem] w-[30rem] flex items-center justify-center ">
              <PinContainer>
                <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] ">
                  ...
                  <div className="flex flex-1 w-full rounded-lg mt-4 bg-gradient-to-br from-violet-500 via-purple-500 to-blue-500" />
                  <img src="https://images.pexels.com/photos/3790811/pexels-photo-3790811.jpeg" />
                </div>
              </PinContainer>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row lg:gap-2">
            <div className="flex h-full flex-col lg:w-[450px] items-center text-center gap-5">
              <div className="max-w-[100px]">
                <img className="" src="/document.png" />
              </div>
            ...
            <div className="flex h-full flex-col lg:w-[450px] items-center text-center gap-5">
              <div className="max-w-[100px]">
                <img className="" src="/computer.png" />
              </div>
